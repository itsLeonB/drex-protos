...
var file_debt_v1_debt_message_proto_goTypes = []any{
	...
	(*TransactionResponse)(nil),                 // 9: debt.v1.TransactionResponse
	(*GroupExpenseData)(nil),                    // 10: debt.v1.GroupExpenseData
}
var file_debt_v1_debt_message_proto_depIdxs = []int32{
	...
	8,  // 1: debt.v1.RecordNewTransactionRequest.amount:type_name -> google.type.Money
	9,  // 2: debt.v1.RecordNewTransactionResponse.transaction:type_name -> debt.v1.TransactionResponse
	9,  // 3: debt.v1.GetTransactionsResponse.transactions:type_name -> debt.v1.TransactionResponse
	10, // 4: debt.v1.ProcessConfirmedGroupExpenseRequest.group_expense:type_name -> debt.v1.GroupExpenseData
	9,  // 5: debt.v1.GetAllByProfileIdsResponse.transactions:type_name -> debt.v1.TransactionResponse

...
func (UnimplementedDebtServiceServer) RecordNewTransaction(context.Context, *RecordNewTransactionRequest) (*RecordNewTransactionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RecordNewTransaction not implemented")
}
...
func (UnimplementedDebtServiceServer) ProcessConfirmedGroupExpense(context.Context, *ProcessConfirmedGroupExpenseRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method ProcessConfirmedGroupExpense not implemented")
}
func (UnimplementedDebtServiceServer) GetAllByProfileIds(context.Context, *GetAllByProfileIdsRequest) (*GetAllByProfileIdsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAllByProfileIds not implemented")
}
